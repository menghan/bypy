    ...
    def __dump_exception(self, ex, url, pars, r, act):
        if self.debug or self.verbose:
            ...
            if hasattr(r, 'status_code'):
                ...
                if (r.status_code != 200 and r.status_code != 206) or (not ('method' in pars and pars['method'] == 'download') and url.find('method=download') == -1 and url.find('baidupcs.com/file/') == -1):
    ...
    def __walk_remote_dir_recur(self, remotepath, proceed, remoterootpath, args=None, skip_remote_only_dirs=False):
        ...
        if result == ENoError:
            ...
            for dirj in dirjs:
                ...
                if skip_remote_only_dirs and remoterootpath is not None and \
